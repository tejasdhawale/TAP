...
public class TopU extends AppCompatActivity {
...
//TextView tv;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.topu);
        myRef = database.getReference("topu");
        //  arr = new ArrayList<>();
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                arr.add(key);
                arr1.add(value);
                Log.d(getClass().getName(), "key me : "+key);
                Log.d(getClass().getName(), "value me : "+value);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(TopU.this, "error " + databaseError, Toast.LENGTH_LONG).show();
